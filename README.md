...
This will add a name to the place. Returns `this` for chaining. `from` defaults to `-9999-01-01` and `to` defaults to `9999-12-31`.
````javascript
var place = opdSDK.createPlace()
...
This will add a geoJSON to the place. Returns `this` for chaining. `from` defaults to `-9999-01-01` and `to` defaults to `9999-12-31`.
````javascript
